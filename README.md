...
```bash
composer require digiservnet/data-transfer-object
```
...
If you've found a bug regarding security please mail [ian.h@digiserv.net](mailto:ian.h@digiserv.net) instead of using the issue tracker.
